...
<body class="bg-gray-50 min-h-screen">
    ...
    <script>
        ...
        let state = {
            ...
            images: [],
            pendingUsers: [],
            productionCategories: [...db.productionCategories],
            warehouseCategories: [...db.warehouseCategories]
        };
        ...
        function render() {
            ...
            setTimeout(addEventListeners, 100); // Añadir un pequeño retraso para asegurar que los elementos están cargados
        }
                ...
                <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="mt-12 bg-white rounded-xl p-6 shadow-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <h4 class="text-lg font-semibold text-gray-800 mb-3">Usuarios Pendientes</h4>
            ...
            <div class="min-h-screen bg-gray-50">
                ...
                <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div class="mt-8 bg-white rounded-xl p-6 shadow-lg">
                        <h3 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                            <i class="fas fa-cog mr-3 text-blue-600"></i> Gestión de Categorías
                        </h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    ...
                                    <button id="addProductionCategory" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-r-lg transition-colors">
                            ...
                            <div>
                                ...
                                <div class="flex">
                                    <input type="text" id="newWarehouseCategory" 
                                           class="flex-1 px-4 py-2 border border-gray-300 rounded-l-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                           placeholder="Nueva categoría...">
                                    <button id="addWarehouseCategory" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-r-lg transition-colors">
                                        <i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            </div>
        ...
        function getViewIncidentsComponent() {
            ...
            <div class="min-h-screen bg-gray-50">
                ...
                <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div class="mb-8">
                        <h2 class="text-2xl font-bold text-gray-900 mb-2">Historial de Incidencias</h2>
                        <p class="text-gray-600">Visualiza y elimina las incidencias reportadas</p>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-white rounded-xl shadow-lg p-6 incident-item" data-id="${incident.id}">
                            ...
                            <div class="incident-actions">
                                <button class="action-btn delete-btn" data-id="${incident.id}" onclick="deleteIncident(${incident.id})">
        ...
        // Función global para eliminar incidencias
        window.deleteIncident = function(incidentId) {
            if (confirm('¿Estás seguro de que deseas eliminar esta incidencia? Esta acción no se puede deshacer.')) {
                ...
                db.incidents = db.incidents.filter(i => i.id != incidentId);
        ...
        function addEventListeners() {
            ...
            document.querySelectorAll('.approve-user').forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    const user = db.pendingUsers.find(u => u.email === email);
                    if (user) {
                        db.users.push({ ...user, approved: true });
        ...
        function handleLogin(e) {
            ...
            const user = [...db.users, ...db.pendingUsers].find(u => u.email === email && u.password === password);
            if (user) {
        ...
        function handleRegister(e) {
            ...
            if (db.users.some(u => u.email === email) || db.pendingUsers.some(u => u.email === email)) {
        ...
        function handleIncidentSubmit(e) {
            ...
            alert('Incidencia reportada correctamente. Se ha enviado un correo a los responsables correspondientes.');
